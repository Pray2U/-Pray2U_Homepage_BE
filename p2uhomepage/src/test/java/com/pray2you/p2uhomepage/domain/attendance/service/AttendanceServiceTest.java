...
//
//        CreateAttendanceResponseDTO responseDTO = CreateAttendanceResponseDTO.toDTO(attendance, 1L);
//
//        //given
...
//    }
    ...
    void readAttendance() {
        ...
        //given
        BDDMockito.given(userRepository.findByIdAndDeleted(anyLong(), anyBoolean())).willReturn(Optional.of(user));
        BDDMockito.given(attendanceRepository.findAllByUserAndCreateDateGreaterThanEqualAndCreateDateLessThan(any(), any(), any())).willReturn(List.of(attendance));
