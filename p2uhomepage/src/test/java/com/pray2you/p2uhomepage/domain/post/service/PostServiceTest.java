...
import com.pray2you.p2uhomepage.domain.user.dto.response.CreateUserByAdditionalInfoResponseDTO;
import com.pray2you.p2uhomepage.domain.user.dto.response.DeleteUserResponseDTO;
...
class PostServiceTest {
    ...
    void deletePost() {
        ...
        //given
        BDDMockito.given(postRepository.findByIdAndDeleted(anyLong(), anyBoolean())).willReturn(Optional.of(post));
        BDDMockito.given(postRepository.save(any())).willReturn(post.delete());
    ...
    void readAllPost() {
        ...
        //when
        Page<ReadPostResponseDTO> result = postService.readAllPost(PageRequest.of(0, 20));
